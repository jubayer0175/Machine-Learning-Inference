...
module platformniossdram_mm_interconnect_0 (
	...
	wire  [104:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_0_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // pio_0_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_1_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // pio_1_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> pio_1_s1_agent:cp_channel
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> pio_2_s1_agent:cp_valid
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> pio_2_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // pio_2_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> pio_2_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> pio_2_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> pio_2_s1_agent:cp_endofpacket
	...
	wire  [104:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> timer_1_s1_agent:cp_data
	...
	wire   [86:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [104:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [104:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_008:sink_data
	...
	wire          pio_2_s1_agent_rp_valid;                                                            // pio_2_s1_agent:rp_valid -> router_009:sink_valid
	wire  [104:0] pio_2_s1_agent_rp_data;                                                             // pio_2_s1_agent:rp_data -> router_009:sink_data
	wire          pio_2_s1_agent_rp_ready;                                                            // router_009:sink_ready -> pio_2_s1_agent:rp_ready
	wire          pio_2_s1_agent_rp_startofpacket;                                                    // pio_2_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          pio_2_s1_agent_rp_endofpacket;                                                      // pio_2_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [104:0] timer_1_s1_agent_rp_data;                                                           // timer_1_s1_agent:rp_data -> router_010:sink_data
	...
	wire   [86:0] router_005_src_data;                                                                // router_005:src_data -> sdram_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                               // sdram_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [8:0] router_005_src_channel;                                                             // router_005:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire  [104:0] sdram_s1_rsp_width_adapter_src_data;                                                // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	...
	wire  [104:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sdram_s1_cmd_width_adapter:in_data
	...
	wire  [104:0] rsp_demux_003_src0_data;                                                            // rsp_demux_003:src0_data -> crosser_001:in_data
	...
	wire  [104:0] crosser_001_out_data;                                                               // crosser_001:out_data -> rsp_mux:sink3_data
	...
	wire          pio_2_s1_agent_rdata_fifo_src_valid;                                                // pio_2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] pio_2_s1_agent_rdata_fifo_src_data;                                                 // pio_2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          pio_2_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_007:in_0_ready -> pio_2_s1_agent:rdata_fifo_src_ready
	...
	platformniossdram_mm_interconnect_0_router_003 router_004 (
	...
	platformniossdram_mm_interconnect_0_router_002 router_006 (
	...
	platformniossdram_mm_interconnect_0_router_002 router_007 (
	...
	platformniossdram_mm_interconnect_0_router_002 router_008 (
	...
	platformniossdram_mm_interconnect_0_router_002 router_009 (
	...
	platformniossdram_mm_interconnect_0_router_002 router_010 (
	...
	platformniossdram_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (pll_0_outclk0_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (pll_0_outclk2_clk),                       //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (pll_0_outclk0_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
